...
#[component]
pub fn ChatBlock(conversation: ReadSignal<Conversation>) -> impl IntoView {
    ...
    view! {
        <div class="h-screen pb-24 w-full flex flex-col overflow-y-auto border border-gray-300 rounded p-5 bg-gray-100" node_ref=input_ref>
